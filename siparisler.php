...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Sipariş Ekle
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Sipariş Yönet
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Siparişi Düzenle
		<?php } ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/SiparisEkle.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Müşteri Adı</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Müşteri Adını Giriniz" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Müşteri İletişim</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Müşteri Numarasını Giriniz" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Alt Tutar</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">KDV 13%</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Toplam Tutar</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Genel Toplam</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Ödenecek Tutar</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Ödeme Türü</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Yükleniyor..."> <i class="glyphicon glyphicon-plus-sign"></i> Ürün Ekle </button>

			      <button type="submit" id="createOrderBtn" data-loading-text="Yükleniyor..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Kaydet</button>

			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Temizle</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/SiparisDüzenle.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Müşteri Adı</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Müşteri Adını Giriniz" autocomplete="off" value="<?php echo $data[2] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Müşteri İletişim</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="İletişim Numarasını Giriniz" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Yükleniyor..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Kaydet</button>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-9">
			      <select class="form-control" name="paymentStatus" id="paymentStatus">
			      	<option value="">~~Seçiniz~~~~</option>
			      	<option value="1">Full Ödeme</option>
			      	<option value="2">Ön Ödeme</option>
			      	<option value="3">Ödeme Yok</option>
			      </select>
			    </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updatePaymentOrderBtn" data-loading-text="Yükleniyor..."> <i class="glyphicon glyphicon-ok-sign"></i> Kaydet</button>	
      </div>           
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Sil</h4>
      </div>
      ...
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Kapat</button>
        <button type="button" class="btn btn-primary" id="removeOrderBtn" data-loading-text="Yükleniyor..."> <i class="glyphicon glyphicon-ok-sign"></i> Kaydet</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
